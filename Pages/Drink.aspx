<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Drink.aspx.cs" Inherits="InternshipWebsite.Drink" %>
...
<body style="background-color: #f5daff;">
    ...
    <form id="form1" runat="server">
        <div class="page">
            <div class="header">
                <div>
                    <img class="header-logo" src="images/drink.png" />
                </div>
