<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Breakfast.aspx.cs" Inherits="InternshipWebsite.Breakfast" %>
...
<head runat="server">
    ...
    <title>Breakfast - Neslicous</title>
...
<body style="background-color: #f5daff;">
    ...
    <form id="form1" runat="server">
        <div class="page">
            <div class="header">
                <div>
                    <img class="header-logo" src="images/breakfast.png" />
                </div>
...
<!-- id="longExplanation" aria-labelledby="exampleLongExplanation" aria-hidden="true" -->
